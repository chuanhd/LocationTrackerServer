...
function getImage(req, res, next){
  db.any('select imagesupload.url, imagesupload.lat, imagesupload.lon, userprofile.userid, userprofile.username as author from imagesupload, userprofile where imagesupload.userid=userprofile.userid and groupid=$1;', [req.query.groupid])
    .then(function (data) {
        res.status(200)
          .json({
